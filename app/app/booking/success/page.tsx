    ...
    return (
      <div
        className={`min-h-screen flex items-center justify-center ${
          isDark ? "bg-[#0B0B1B]" : "bg-gradient-to-br from-green-50 to-blue-50"
        }`}
      >
        <div
          className={`animate-spin rounded-full h-12 w-12 border-b-2 ${isDark ? "border-green-400" : "border-green-600"}`}
        ></div>
      </div>
    )
  }
...
export default function BookingSuccessPage() {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 dark:bg-[#0B0B1B] flex items-center justify-center">
