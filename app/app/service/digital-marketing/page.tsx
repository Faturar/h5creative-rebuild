          ...
          <div className="relative flex flex-col sm:flex-row gap-8 lg:gap-16 min-h-[80vh] w-full items-center justify-between">
            ...
            >
              ...
              >
                ...
                <span>#TUMBUHKAN BRANDMU SECARA DIGITAL</span>
              </motion.div>
              ...
              <motion.p
                ...
                variants={itemVariants}
              >
                Solusi digital marketing komprehensif untuk menumbuhkan presence
                online dan meningkatkan konversi. Dari SEO hingga iklan
                berbayar, kami buat strategi yang meningkatkan visibilitas.
              </motion.p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-gray-400 max-w-2xl mx-auto">
              Strategi marketing berbasis data yang memberikan hasil nyata
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Optimasi mesin pencari untuk meningkatkan ranking organik",
              },
              {
                icon: BarChart3,
                title: "PPC Advertising",
                description:
                  "Iklan berbayar yang terarah dengan ROI tinggi",
              },
              {
                icon: TrendingUp,
                title: "Analytics & Reporting",
                description:
                  "Analisis mendalam dan laporan performa berkala",
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          <motion.div variants={itemVariants}>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
              Siap untuk Tumbuh Secara Digital?
            </h2>
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Mari diskusikan bagaimana kami bisa membantu brand kamu
              mencapai target bisnis dengan strategi digital marketing yang tepat.
            </p>
            <Link
              href="/booking"
