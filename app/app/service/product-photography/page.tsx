...
import { ArrowRight, CheckCircle2, Camera, Sparkles, Image as ImageIcon } from "lucide-react"
...
export default function ProductPhotographyPage() {
  return (
    <>
          ...
          <div className="relative flex flex-col sm:flex-row gap-8 lg:gap-16 min-h-[80vh] w-full items-center justify-between">
            ...
            >
              ...
              >
                ...
                <span>#PRODUK KAMU TAMPIL MENARIK</span>
              </motion.div>
              ...
              <motion.p
                ...
                variants={itemVariants}
              >
                Perlihatkan produkmu dengan fotografi profesional yang
                menonjolkan fitur terbaiknya. Fotografer kami menggunakan
                pencahayaan profesional dan peralatan untuk menciptakan
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
              Layanan Product Photography
            </h2>
            <p className="text-lg text-gray-400 max-w-2xl mx-auto">
              Foto produk profesional yang menonjolkan keunggulan produkmu
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Pencahayaan profesional untuk hasil yang sempurna",
              },
              {
                icon: ImageIcon,
                title: "High-Resolution",
                description: "Gambar resolusi tinggi untuk semua kebutuhan",
              },
              {
                icon: Sparkles,
                title: "Multi-Angle Shots",
                description:
                  "Banyak angle untuk menampilkan produk dari berbagai sisi",
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
      ...
      {/* CTA Section */}
      <motion.section
        className="w-full py-20 md:py-32 px-8 lg:px-16 bg-gradient-to-r from-purple-500 to-pink-600"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        variants={containerVariants}
      >
        <div className="max-w-4xl mx-auto text-center">
          <motion.div variants={itemVariants}>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
              Siap untuk Menampilkan Produk Terbaik?
            </h2>
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Mari diskusikan bagaimana kami bisa membantu menciptakan
              foto produk yang menakjubkan untuk bisnis kamu.
            </p>
            <Link
              href="/booking"
              className="inline-flex items-center justify-center gap-3 bg-white text-purple-600 font-bold px-8 py-4 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
            >
              BOOKING SEKARANG
              <ArrowRight className="w-5 h-5" />
            </Link>
