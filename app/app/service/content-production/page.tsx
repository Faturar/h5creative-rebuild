...
import { ArrowRight, Camera, Video, Play, Sparkles, TrendingUp } from "lucide-react"
          ...
          <div className="relative flex flex-col sm:flex-row gap-8 lg:gap-16 min-h-[80vh] w-full items-center justify-between">
            ...
            >
              ...
              >
                ...
                <span>#KONTEN PROFESIONAL BIKIN BRAND TERLIHAT</span>
              </motion.div>
              ...
              <motion.p
                ...
                variants={itemVariants}
              >
                Buat konten foto dan video profesional yang menampilkan brand
                kamu dengan cara terbaik. Tim profesional dan peralatan berkualitas
                memastikan hasil yang menakjubkan setiap saat.
              </motion.p>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-400">Produk Terfoto</div>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-400">Video Terproduksi</div>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-400">Kualitas Profesional</div>
                  </div>
                </div>
              </motion.div>
            </motion.div>
            ...
            >
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-b from-gray-900 to-black p-4 flex flex-col">
                  ...
                  <div className="flex-1 bg-gradient-to-br from-blue-900 to-cyan-900 rounded-xl relative overflow-hidden">
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 p-3">
                      <p className="text-white text-xs">New Collection! ✨</p>
                    </div>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-b from-gray-900 to-black p-4 flex flex-col">
                  ...
                  <div className="flex-1 bg-gradient-to-br from-cyan-900 to-purple-900 rounded-xl relative overflow-hidden flex items-center justify-center">
                    ...
                    <div className="absolute top-2 right-2 bg-black/50 px-2 py-1 rounded text-[10px] text-white flex items-center gap-1">
                      <TrendingUp className="w-3 h-3" /> 8.5K
                    </div>
