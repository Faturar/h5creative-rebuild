...
import { ArrowRight, CheckCircle2, Box, Palette, Layers } from "lucide-react"
...
export default function BrandIdentityVisualDesignPage() {
  return (
    <>
      <motion.section
          ...
          <div className="relative flex flex-col sm:flex-row gap-8 lg:gap-16 min-h-[80vh] w-full items-center justify-between">
            ...
            >
              ...
              >
                ...
                <span>#IDENTITAS BRAND YANG KUAT</span>
              </motion.div>
              ...
              <motion.p
                ...
                variants={itemVariants}
              >
                Kami bantu kamu menciptakan identitas brand yang unik dan
                memorable. Melalui pendekatan strategis, kami develop sistem
                visual yang meliputi logo, palet warna, tipografi, dan panduan
                penggunaan yang konsisten di seluruh titik kontak brand.
              </motion.p>
            ...
            <motion.div
              ...
              variants={itemVariants}
            >
              <div className="absolute w-96 h-96 bg-cyan-600/30 rounded-full blur-3xl"></div>
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-b from-gray-900 to-black p-4 flex flex-col">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <div className="bg-cyan-600 px-2 py-1 rounded text-[10px] font-bold text-white">
                      ID
                    </div>
                  </div>
                  <div className="flex-1 bg-gradient-to-br from-cyan-900 to-blue-900 rounded-xl relative overflow-hidden flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
              Layanan Brand Identity & Visual Design
            </h2>
            <p className="text-lg text-gray-400 max-w-2xl mx-auto">
              Membangun identitas visual yang kuat, konsisten, dan memorable
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Desain logo dan sistem identitas yang komprehensif",
              },
              {
                icon: Palette,
                title: "Color Palette & Typography",
                description:
                  "Palet warna dan tipografi yang sesuai brand",
              },
              {
                icon: Layers,
                title: "Brand Guidelines & Style Guide",
                description:
                  "Panduan lengkap untuk penggunaan brand",
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
      ...
      {/* CTA Section */}
      <motion.section
        className="w-full py-20 md:py-32 px-8 lg:px-16 bg-gradient-to-r from-cyan-500 to-blue-600"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        variants={containerVariants}
      >
        <div className="max-w-4xl mx-auto text-center">
          <motion.div variants={itemVariants}>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
              Siap untuk Membangun Identitas Brand?
            </h2>
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Mari diskusikan bagaimana kami bisa membantu menciptakan
              identitas visual yang unik dan kuat untuk brand kamu.
            </p>
            <Link
              href="/booking"
              className="inline-flex items-center justify-center gap-3 bg-white text-cyan-600 font-bold px-8 py-4 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
            >
              BOOKING SEKARANG
              <ArrowRight className="w-5 h-5" />
            </Link>
