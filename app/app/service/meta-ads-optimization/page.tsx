...
export default function MetaAdsOptimizationPage() {
  return (
    <>
      <motion.section
          ...
          <div className="relative flex flex-col sm:flex-row gap-8 lg:gap-16 min-h-[80vh] w-full items-center justify-between">
            ...
            >
              ...
              >
                ...
                <span>#MAKSIMALKAN ROI IKLANMU</span>
              </motion.div>
              ...
              <motion.p
                ...
                variants={itemVariants}
              >
                Maksimalkan ROI iklanmu dengan manajemen Meta Ads kami.
                Kami buat, optimasi, dan scale kampanye yang menarget audiens
                dan mendorong konversi di Facebook dan Instagram.
              </motion.p>
            ...
            <motion.div
              ...
              variants={itemVariants}
            >
              <div className="absolute w-96 h-96 bg-blue-600/30 rounded-full blur-3xl"></div>
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-b from-gray-900 to-black p-4 flex flex-col">
                  ...
                  <div className="flex-1 bg-gradient-to-br from-blue-900 to-cyan-900 rounded-xl relative overflow-hidden flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
              Layanan Meta Ads Optimization
            </h2>
            <p className="text-lg text-gray-400 max-w-2xl mx-auto">
              Manajemen iklan Facebook dan Instagram yang terarah dan efektif
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Strategi kampanye yang terarah dan terukur",
              },
              {
                icon: BarChart3,
                title: "Ad Creation & Testing",
                description:
                  "Buat dan tes iklan untuk hasil terbaik",
              },
              {
                icon: TrendingUp,
                title: "Audience Targeting",
                description:
                  "Penargetan audiens yang tepat untuk ROI maksimal",
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
                className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-blue-500/50 transition-all"
                variants={itemVariants}
              >
      ...
      {/* CTA Section */}
      <motion.section
        className="w-full py-20 md:py-32 px-8 lg:px-16 bg-gradient-to-r from-blue-500 to-cyan-600"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        variants={containerVariants}
      >
        <div className="max-w-4xl mx-auto text-center">
          <motion.div variants={itemVariants}>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
              Siap untuk Maksimalkan ROI Iklan?
            </h2>
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Mari diskusikan bagaimana kami bisa membantu meningkatkan
              performa kampanye iklanmu.
            </p>
            <Link
              href="/booking"
              className="inline-flex items-center justify-center gap-3 bg-white text-blue-600 font-bold px-8 py-4 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
            >
              BOOKING SEKARANG
              <ArrowRight className="w-5 h-5" />
            </Link>
