...
import { ArrowRight, CheckCircle2, Sparkles, FileText, BarChart3 } from "lucide-react"
...
export default function CreativeContentCampaignPage() {
  return (
    <>
      <motion.section
          ...
          <div className="relative flex flex-col sm:flex-row gap-8 lg:gap-16 min-h-[80vh] w-full items-center justify-between">
            ...
            >
              ...
              >
                ...
                <span>#KONTEN KREATIF YANG MENARIK</span>
              </motion.div>
              ...
              <motion.p
                ...
                variants={itemVariants}
              >
                Kami buat konten dan kampanye yang tidak hanya menarik perhatian
                tapi juga memberikan dampak nyata. Dari strategi konten hingga
                eksekusi kreatif, kami pastikan setiap konten relevan dengan
                audiens dan sesuai dengan target bisnis kamu.
              </motion.p>
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-b from-gray-900 to-black p-4 flex flex-col">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <div className="bg-pink-600 px-2 py-1 rounded text-[10px] font-bold text-white">
                      NEW
                    </div>
                  </div>
                  <div className="flex-1 bg-gradient-to-br from-pink-900 to-rose-900 rounded-xl relative overflow-hidden flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
              Layanan Creative Content & Campaign
            </h2>
            <p className="text-lg text-gray-400 max-w-2xl mx-auto">
              Konten kreatif dan kampanye untuk meningkatkan engagement
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Strategi konten yang terarah dan terjadwal",
              },
              {
                icon: Sparkles,
                title: "Social Media Content",
                description:
                  "Konten media sosial yang menarik dan relevan",
              },
              {
                icon: BarChart3,
                title: "Campaign Concept & Creative",
                description:
                  "Konsep kampanye kreatif yang berdampak",
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
                className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-pink-500/50 transition-all"
                variants={itemVariants}
              >
      ...
      {/* CTA Section */}
      <motion.section
        className="w-full py-20 md:py-32 px-8 lg:px-16 bg-gradient-to-r from-pink-500 to-rose-600"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        variants={containerVariants}
      >
        <div className="max-w-4xl mx-auto text-center">
          <motion.div variants={itemVariants}>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
              Siap untuk Membuat Kampanye Kreatif?
            </h2>
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Mari diskusikan bagaimana kami bisa membantu membuat konten
              dan kampanye kreatif untuk brand kamu.
            </p>
            <Link
              href="/booking"
              className="inline-flex items-center justify-center gap-3 bg-white text-pink-600 font-bold px-8 py-4 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
            >
              BOOKING SEKARANG
              <ArrowRight className="w-5 h-5" />
            </Link>
