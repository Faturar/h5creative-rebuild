...
export default function LogoSection() {
  return (
    <section className="w-full bg-[#0B0B0D] py-24 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        {/* SLIDER */}
        <div className="relative group/slider">
          <div className="flex w-max items-center">
            {/* FIRST TRACK */}
            <div className="flex animate-[slide_25s_linear_infinite] group-hover/slider:[animation-play-state:paused] gap-20 items-center">
            ...
            <div className="flex animate-[slide_25s_linear_infinite] group-hover/slider:[animation-play-state:paused] gap-20 items-center ml-20">
              {[logo1, logo2, logo3, logo4, logo1, logo2, logo3, logo4].map(
                (logo, index) => (
                  <div
                    key={`dup-${index}`}
