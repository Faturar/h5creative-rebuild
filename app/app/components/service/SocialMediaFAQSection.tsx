...
import { socialMediaFAQ } from "@/app/constants/faq"
...
export default function SocialMediaFAQSection() {
  const [active, setActive] = useState<number | null>(
    socialMediaFAQ.defaultActiveIndex,
  )
