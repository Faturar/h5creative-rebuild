  ...
  try {
    ...
    await prisma.$transaction(
      ...
      const packages = await Promise.all([
        ...
        tx.package.create({
          data: {
            name: "Package D (iPhone)",
            packageType: "iPhone",
            description: "Paket flagship dengan 1-2 host dan kualitas video terbaik.",
        ...
        tx.package.create({
          data: {
            ...
            price: toDecimal(9000000),
            promoPrice: toDecimal(7740000),
            hasActivePromo: true,
            promoTitle: "Promo Launching",
            promoStartDate: promoStartDate,
            promoEndDate: promoEndDate,
            promoDiscountType: "fixed",
            promoDiscountValue: toDecimal(1260000),
            totalHours: 52,
            numberOfDays: 26,
            durationPerSession: 2,
            workTimeStart: "09:00",
        ...
        tx.package.create({
          data: {
            ...
            promoPrice: toDecimal(11821600),
            hasActivePromo: true,
            promoTitle: "Promo Launching",
            promoStartDate: promoStartDate,
            promoEndDate: promoEndDate,
            promoDiscountType: "fixed",
            promoDiscountValue: toDecimal(2178400),
            totalHours: 78,
            numberOfDays: 26,
        ...
        tx.package.create({
          data: {
            ...
            promoPrice: toDecimal(13292800),
            hasActivePromo: true,
            promoTitle: "Promo Launching",
            promoStartDate: promoStartDate,
            promoEndDate: promoEndDate,
            promoDiscountType: "fixed",
            promoDiscountValue: toDecimal(2707200),
            totalHours: 104,
            numberOfDays: 26,
            durationPerSession: 4,
            workTimeStart: "09:00",
        ...
        tx.package.create({
          data: {
            ...
            promoPrice: toDecimal(18425000),
            hasActivePromo: true,
            promoTitle: "Promo Launching",
            promoStartDate: promoStartDate,
            promoEndDate: promoEndDate,
            promoDiscountType: "fixed",
            promoDiscountValue: toDecimal(3575000),
            totalHours: 156,
            numberOfDays: 26,
            durationPerSession: 6,
            workTimeStart: "09:00",
