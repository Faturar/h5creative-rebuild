      ...
      const packages = await Promise.all([
        ...
        tx.package.create({
          data: {
            ...
            promoEndDate: promoEndDate,
            promoDiscountType: "fixed",
            promoDiscountValue: toDecimal(1240000),
            totalHours: 104,
            numberOfDays: 26,
        ...
        tx.package.create({
          data: {
            ...
            promoEndDate: promoEndDate,
            promoDiscountType: "fixed",
            promoDiscountValue: toDecimal(2340000),
            totalHours: 156,
            numberOfDays: 26,
        ...
        tx.package.create({
          data: {
            name: "Package D",
            packageType: "OBS Sistem",
            description: "Pemakaian Green Screen, Bisa memakai animasi bergerak dan full desain, Fleksibilitas Desain untuk Campaign, Kamera Profesional dan Sistem Stabil, Kualitas Gambar HD",
        ...
        tx.package.create({
          data: {
            ...
            promoEndDate: promoEndDate,
            promoDiscountType: "fixed",
            promoDiscountValue: toDecimal(5000000),
            totalHours: 78,
            numberOfDays: 26,
            durationPerSession: 3,
            workTimeStart: "09:00",
        ...
        tx.package.create({
          data: {
            ...
            promoEndDate: promoEndDate,
            promoDiscountType: "fixed",
            promoDiscountValue: toDecimal(5100000),
            totalHours: 104,
            numberOfDays: 26,
            durationPerSession: 4,
            workTimeStart: "09:00",
        ...
        tx.package.create({
          data: {
            ...
            promoEndDate: promoEndDate,
            promoDiscountType: "fixed",
            promoDiscountValue: toDecimal(7400000),
            totalHours: 156,
            numberOfDays: 26,
            durationPerSession: 6,
            workTimeStart: "09:00",
